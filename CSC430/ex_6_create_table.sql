...
-- Schema elonbuster
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `elonbuster` DEFAULT CHARACTER SET utf8 ;
USE `elonbuster` ;

-- -----------------------------------------------------
-- Table `elonbuster`.`RentalLocation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `elonbuster`.`RentalLocations` ;

CREATE TABLE IF NOT EXISTS `elonbuster`.`RentalLocations` (
