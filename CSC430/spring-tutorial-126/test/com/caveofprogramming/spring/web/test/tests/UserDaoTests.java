...
public class UserDaoTests {
	...
	public void testCreateUser() {
		com.caveofprogramming.spring.web.dao.User user = new com.caveofprogramming.spring.web.dao.User("johnwpurcell", "hellothere", "john@caveofprogramming.com", true, "ROLE_USER");
