...
-- Table `mvc`.`offers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mvc`.`offers` (
...
-- -----------------------------------------------------
-- Table `mvc`.`rentallocations`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mvc`.`rentallocations` (
...
-- Table `mvc`.`messages`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mvc`.`messages` (
  `id` INT NOT NULL,
